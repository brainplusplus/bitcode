...
@Component({ tag: 'bc-field-datetime', styleUrl: 'bc-field-datetime.css', shadow: false })
    ...
    return (
      <div class={fieldClasses}>
        ...
        <div class="bc-field-input-wrapper">
          <input ref={(el) => this._inputEl = el} id={this.name} type="datetime-local" class={inputClasses} name={this.name} value={this.value} placeholder={this.placeholder} required={this.required} readOnly={this.readonly} disabled={this.disabled} min={this.min || undefined} max={this.max || undefined} onInput={(e: Event) => this.handleInput(e)} onFocus={() => this.handleFocus()} onBlur={() => this.handleBlur()} {...ariaAttrs} />
