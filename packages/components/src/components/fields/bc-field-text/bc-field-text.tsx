...
@Component({ tag: 'bc-field-text', styleUrl: 'bc-field-text.css', shadow: false })
export class BcFieldText {
  ...
  private async _runValidation(): Promise<ValidationResult> {
    ...
    const result = await validateFieldValue(this.value, { required: this.required, minLength: this.minLength, maxLength: this.maxLength, pattern: this.pattern, patternMessage: this.patternMessage }, { validators: this.validators, customValidator: this.customValidator, serverValidator: this.serverValidator });
